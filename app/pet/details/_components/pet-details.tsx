...
import PetDetailsPageSkeleton from './pet-details-page-skeleton';
import PetDetailsImgageGallery from './pet-details-image-gallery';
import PetDetailsShelterCard from './pet-details-shelter-card';
import { useFetchPetById } from '@/app/pet/_hooks/use-pet-data';
import { useScrollTop } from '@/app/_hooks/use-scroll-top';
