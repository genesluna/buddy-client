    ...
    <div className='pb-8'>
      <div className='h-50 mt-[-4.3125rem] flex flex-col items-start rounded-[1.875rem] bg-white px-[2.5rem] py-[1.875rem]'>
        ...
        <p className='mt-4 text-content-300'>
          ...
          olhando para o panorama geral, alterando o status quo e encontrando
          soluções tecnológicas inovadoras para os maiores desafios enfrentados
          por animais de estimação resgatados na Brasil.
        </p>
      </div>
      <div className='mt-10 lg:mt-20'>
        ...
        <div className='mt-8 rounded-4xl bg-white/20 px-[2.5rem] py-[1.875rem] backdrop-blur-sm transition duration-300 hover:bg-white/40 lg:mt-14'>
          ...
          <p className='mt-4 text-content-300'>
            Somos inovadores digitais, sempre procurando maneiras de aproveitar
            os mais recentes avanços no mundo da tecnologia para resolver os
            grandes problemas e desafios que os animais de estimação resgatados
            enfrentam no Brasil.
          </p>
          ...
          <p className='mt-4 text-content-300'>
            Através de todas as campanhas, programas e serviços inovadores que
            criamos e oferecemos, defendemos ativamente o resgate de animais de
            estimação.
          </p>
          <h3 className='mt-14 text-lg font-semibold text-accent md:text-xl lg:text-2xl'>
          ...
          <p className='mt-4 text-content-300'>
            Unimos animais de estimação a novas famílias, grupos de resgate com
            adotantes e cuidadores adotivos, parceiros corporativos com uma
            comunidade nacional de resgate e unimos todos os defensores
      ...
      <div className='my-10 lg:mt-20'>
        ...
        <div className='mt-8 flex flex-col items-start justify-center rounded-4xl border border-accent bg-white/20 px-[2.5rem] py-[1.875rem] backdrop-blur-sm transition duration-300 hover:bg-white/40 lg:mt-14'>
          ...
          <p className='mt-4 text-content-300'>
            Ele extrai os dados diretamente do próprio administrador do abrigo
            para as informações que sejam atualizados em tempo real conforme os
            abrigos fazem suas alterações.
          </p>
        </div>
        ...
        <div className='mt-10 flex flex-col items-start justify-center rounded-4xl border border-accent bg-white/20 px-[2.5rem] py-[1.875rem] backdrop-blur-sm transition duration-300 hover:bg-white/40'>
          ...
          <p className='mt-4 text-content-300'>
            ...
            perfil do animal será atualizado para informar que há uma adoção em
            processamento, se foi reservado ou se foi adotado.
          </p>
        </div>
        <div className='mt-10 flex flex-col items-start justify-center rounded-4xl border border-accent bg-white/20 px-[2.5rem] py-[1.875rem] backdrop-blur-sm transition duration-300 hover:bg-white/40'>
          <h3 className='text-lg font-semibold text-accent md:text-xl lg:text-2xl'>
