...
export default function About() {
  return (
    <VerticalLayout>
      <div className='pb-8'>
        <section className='h-50 mt-[-4.3125rem] flex flex-col items-start rounded-[1.875rem] bg-white px-[2.5rem] py-[1.875rem]'>
          ...
          <p className='mt-4 text-content-300'>
            ...
            soluções tecnológicas inovadoras para os maiores desafios
            enfrentados por animais de estimação resgatados na Brasil.
          </p>
        </section>
        <section className='mt-10 lg:mt-20'>
          ...
          <div className='mt-8 rounded-4xl bg-white/20 px-[2.5rem] py-[1.875rem] backdrop-blur-sm transition duration-300 hover:bg-white/40 lg:mt-14'>
            ...
            <p className='mt-4 text-content-300'>
              ...
              criamos e oferecemos, defendemos ativamente o resgate de animais
              de estimação.
            </p>
            <h3 className='mt-14 text-lg font-semibold text-accent md:text-xl lg:text-2xl'>
        ...
        <section className='my-10 lg:mt-20'>
          ...
          <div className='mt-8 flex flex-col items-start justify-center rounded-4xl border border-accent bg-white/20 px-[2.5rem] py-[1.875rem] backdrop-blur-sm transition duration-300 hover:bg-white/40 lg:mt-14'>
            ...
            <p className='mt-4 text-content-300'>
              ...
              para as informações que sejam atualizados em tempo real conforme
              os abrigos fazem suas alterações.
            </p>
          </div>
